        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            <div className="flex-1 text-sm text-zinc-600">
              ...
              <p className="text-xs">
                {item?.docData?.address?.line1 || "No address"}
              </p>
            ...
            <div className="flex flex-col justify-end gap-2">
              {!item?.cancelled && !item?.isCompleted && (
                <button className="py-2 text-sm transition border rounded text-stone-500 sm:min-w-48 hover:bg-primary hover:text-white">
                  Pay Online
                </button>
              )}
              ...
              {!item?.cancelled && !item?.isCompleted && (
                <button
                  ...
                  className="py-2 text-sm transition border rounded text-stone-500 sm:min-w-48 hover:bg-red-600 hover:text-white"
                >
                  Cancel appointment
                </button>
              )}
